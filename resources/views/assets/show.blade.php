...
@section('content')
    <div class="container">
        {{ Breadcrumbs::render('campaign.asset.show', $campaign, $user) }}
        @if(session('message'))
                ...
                <div class="card-columns">
                    ...
                    <div class="card" style="">
                        ...
                        @if($asset->file_type === 'image')
                            @if(!empty($asset->file))
                                <img class="card-img-top" src="{{asset($asset->file)}}">
                            @endif
                        @else
                        ...
                        <a href="{{route('assets.show', [$asset->id, $campaign->id, $user->id])}}">
                            <div class="card-body">
                                ...
                                <span class="badge badge-secondary">{{$asset->content_type}}</span>
                            </div>
                        </a>
                    </div>
                </div>
